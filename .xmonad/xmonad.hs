...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm,               xK_W ),     spawn "s/.local/bin/./power-menu")    --power menu
    , ((modm,               xK_p ),     spawn "rofi -show drun &")    --launch rofi
    , ((modm,               xK_b ),     spawn "brave &")               --launch brave
    , ((modm,               xK_space ), spawn "dmenu_run")            --launch dmenu
    , ((modm,               xK_q     ), kill)                         --close focused window
    , ((modm,               xK_s     ), sendMessage NextLayout)       --Rotate through layout 
    , ((modm,               xK_n     ), refresh)        --resize windows to correct size      
    , ((modm,               xK_Tab   ), windows W.focusDown)  --move focus window 
    ...
    , ((modm .|. shiftMask, xK_Return), windows W.swapMaster) --swap the focus & master window
    , ((modm,               xK_h     ), sendMessage Shrink) --shrink the master area   
    , ((modm,               xK_l     ), sendMessage Expand) --expand the master area
    , ((modm,               xK_t     ), withFocused $ windows . W.sink) --push window in tile
...
--
myLayout = smartSpacing 4 $ ( tiled ||| Mirror tiled ||| Full)
  where
